...
Two mocked layers, a plain unit layer, and a config guard, ~1.5s combined for 106 tests at 100% coverage, plus one opt-in live test that runs against the real model:
