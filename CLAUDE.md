...
Two mocked layers, a plain unit layer, and a config guard, ~1s combined for 102 tests at 100% coverage, plus one opt-in live test that runs against the real model:
